...
Four documents, split by the question they answer. Nothing about the history
...
| [`HELIOS.md`](HELIOS.md) | **How do I run it on Helios?** | You are on a Cyfronet Helios node. Module setup, the Slurm cpuset trap, how many cores to ask for and what wall time to expect, why the big grid scales and the small one does not, and which optimisations made it slower. |
